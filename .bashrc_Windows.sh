...
alias t="cd '$lmroot'/LifeManager && ./UtilsTest.sh"

# Running LifeManager tests (manually verified tests)
alias tm="cd '$lmroot'/LifeManager && ./UtilsTestManuallyVerified.sh"

# Running LifeManager tests (user input tests)
alias tui="cd '$lmroot'/LifeManager && ./UtilsTestUserInput.sh"

# Running LifeManager tests (scratch)
alias ts="cd '$lmroot'/LifeManager && ./UtilsTestScratch.sh"

# Running LifeManager tests (all)
alias ta="cd '$lmroot'/LifeManager && ./RunAllTests.sh"
